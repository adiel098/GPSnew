...
public class LosNlosTest {
    private static final double WALL_HEIGHT = 100.0; // Wall height in meters
    private static final double OBSERVER_HEIGHT = 85.5; // Observer height in meters
    ...
    // Parameters for main simulation that will generate KML file
    private static final double MAIN_SIM_AZIMUTH = 45.0; // Azimuth for main simulation
    private static final double MAIN_SIM_ELEVATION = 45.0; // Elevation angle for main simulation
    ...
    private static void testLosNlos(double azimuth, double elevation, boolean generateKmlFile) {
        try {
            ...
            System.out.println("Observer Height: " + String.format("%.1f m", OBSERVER_HEIGHT));
            System.out.println("Wall Height: " + String.format("%.1f m", WALL_HEIGHT));
            ...
            if (!isLos) {
                ...
                if (requiredHeight >= 0) {
                    ...
                    System.out.println("Required observer height: " + String.format("%.2f m", OBSERVER_HEIGHT + requiredHeight));
    ...
    private static void generateKml(Point3D userPoint, Building wall, Satellite satellite, 
        ...
        try {
            ...
            // Create KML output directory if it doesn't exist
