...
public class LosNlosTest {
    ...
    private static final double OBSERVER_HEIGHT = 1.8; // גובה המשתמש במטרים
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("\n=== TEST SUMMARY ===");
            System.out.println("These tests verify if our LOS/NLOS calculation logic works correctly.");
            System.out.println("As the elevation angle increases, we should expect to see more LOS conditions.");
            System.out.println("Results should be consistent with the wall position relative to the observer.");
            System.out.println("\nA KML file has been generated for the main simulation case.");
