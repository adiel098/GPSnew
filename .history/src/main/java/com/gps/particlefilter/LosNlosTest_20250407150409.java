...
public class LosNlosTest {
    ...
    private static final double OBSERVER_HEIGHT = 74.0; // גובה המשתמש במטרים
    ...
    private static void generateKml(Point3D userPoint, Building wall, Satellite satellite, 
        ...
        try {
            ...
            if (intersectionPoint != null && !isLos) {
                ...
                writer.write("<Placemark>\n");
                writer.write("  <name>Intersection Point (" + String.format("%.2f m", zAtIntersection) + 
                             " < " + String.format("%.2f m", WALL_HEIGHT) + ")</name>\n");
